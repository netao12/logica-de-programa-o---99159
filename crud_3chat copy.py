...
def encontrar_cliente_por_email(lista_clientes, email_buscar):
    nome_buscar_lower = email_buscar.lower()
    for cliente in lista_clientes:
        if cliente.email.lower() == email_buscar:
            return cliente
    return None
...
def atualizar_cliente(lista_clientes):
    ...
    email_buscar = input("Digite o email do cliente: ")
...
def excluir_cliente(lista_clientes):
    ...
    email_buscar = input("\nDigite o email1 do cliente que deseja excluir: ")
